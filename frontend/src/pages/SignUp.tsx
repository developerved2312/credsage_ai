  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-sm text-slate-500">Start your financial journey with CredSage AI</p>
      </div>
      ...
      <form onSubmit={handleEmailSignUp} className="space-y-3.5">
        ...
        <button
          ...
          type="submit"
          disabled={loading}
          className="w-full py-2.5 px-4 rounded-lg bg-emerald-800 hover:bg-emerald-900 text-white font-medium text-sm transition-colors shadow-sm disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer mt-1"
        >
          {loading ? (
            <>
